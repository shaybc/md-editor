(function(window, document) {
  ...
  function registerMarkdownViewerAiCompanionPanel(app, deps) {
    ...
    function validateAgentStateSnapshotForTask(snapshot, record) {
      ...
      if (![1, 2, 3].includes(snapshot?.schemaVersion) || snapshot?.snapshotKind !== "terminal") errors.push("invalid-snapshot-envelope");
      if (!state || ![1, 2, 3].includes(state.schemaVersion)) errors.push("invalid-agent-state");

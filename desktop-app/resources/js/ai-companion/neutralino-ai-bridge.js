(function(window) {
  ...
  function registerMarkdownViewerNeutralinoAiBridge(app, deps) {
    ...
    const api = {
      ...
      changeJournalPreviewRestore: function(payload) { return request("change_journal_preview_restore", payload || {}); },
      changeJournalApplyRestore: function(payload) { return request("change_journal_apply_restore", payload || {}); },
      changeJournalFileHistory: function(payload) { return request("change_journal_file_history", payload || {}); },
      changeJournalCompareCheckpoint: function(payload) { return request("change_journal_compare_checkpoint", payload || {}); },

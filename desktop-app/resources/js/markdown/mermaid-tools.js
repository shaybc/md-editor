(function(global) {
  global.registerMarkdownViewerMermaidTools = function registerMarkdownViewerMermaidTools(app, deps) {
    ...
    const fallbackMarkdownPreview = deps.markdownPreview;
    const getActiveMarkdownPreview = deps.getActiveMarkdownPreview || function() { return fallbackMarkdownPreview; };
  ...
  addMermaidToolbars = function addMermaidToolbars() {
    const markdownPreview = getActiveMarkdownPreview();

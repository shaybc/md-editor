...
(function(global) {
  ...
  const MENU_ITEMS = [
    ...
    { effectIcon: "effects", label: "Layer Style", children: [
      ...
      { id: "edit-paint-edge", effectIcon: "paint-edge", label: "Paint Edge\u2026" },
      { id: "edit-collage", effectIcon: "collage", label: "Collage\u2026" },
      { id: "edit-dots", effectIcon: "dots", label: "Dots\u2026" },
      { id: "edit-points", effectIcon: "points", label: "Points\u2026" },
      { id: "edit-watercolor", effectIcon: "watercolor", label: "Watercolor\u2026" },
      { id: "edit-sunset", effectIcon: "sunset", label: "Sunset\u2026" },
      { id: "edit-color-grid", effectIcon: "color-grid", label: "ColorGrid\u2026" },
      { id: "edit-vertical-panels", effectIcon: "vertical-panels", label: "Vertical Panels\u2026" },
      { id: "edit-polaroids", effectIcon: "polaroids", label: "Polaroids\u2026" },
      { id: "edit-miniature", effectIcon: "miniature", label: "Miniature\u2026" },
      { id: "edit-puzzle", effectIcon: "puzzle", label: "Puzzle\u2026" },
      { id: "edit-texturize", effectIcon: "texturize", label: "Texturize\u2026" },
      ...
      { id: "edit-posterize", effectIcon: "posterize", label: "Posterize\u2026" },
      { id: "edit-contrast-bw", effectIcon: "contrast-bw", label: "Contrast B&W\u2026" },
      { id: "edit-monochromatic", effectIcon: "monochromatic", label: "Monochromatic\u2026" },
      { id: "edit-pencil-sketch", effectIcon: "pencil-sketch", label: "Pencil-Sketch\u2026" },
      { id: "edit-pic-in-pic", effectIcon: "pic-in-pic", label: "Pic-in-Pic\u2026" },
      ...
      { icon: "bi-x-square", label: "Remove", children: [
        ...
        { id: "remove-paint-edge", effectIcon: "paint-edge", label: "Paint Edge" },
        { id: "remove-collage", effectIcon: "collage", label: "Collage" },
        { id: "remove-dots", effectIcon: "dots", label: "Dots" },
        { id: "remove-points", effectIcon: "points", label: "Points" },
        { id: "remove-watercolor", effectIcon: "watercolor", label: "Watercolor" },
        { id: "remove-sunset", effectIcon: "sunset", label: "Sunset" },
        { id: "remove-color-grid", effectIcon: "color-grid", label: "ColorGrid" },
        { id: "remove-vertical-panels", effectIcon: "vertical-panels", label: "Vertical Panels" },
        { id: "remove-polaroids", effectIcon: "polaroids", label: "Polaroids" },
        { id: "remove-miniature", effectIcon: "miniature", label: "Miniature" },
        { id: "remove-puzzle", effectIcon: "puzzle", label: "Puzzle" },
        { id: "remove-texturize", effectIcon: "texturize", label: "Texturize" },
        ...
        { id: "remove-posterize", effectIcon: "posterize", label: "Posterize" },
        { id: "remove-contrast-bw", effectIcon: "contrast-bw", label: "Contrast B&W" },
        { id: "remove-monochromatic", effectIcon: "monochromatic", label: "Monochromatic" },
        { id: "remove-pencil-sketch", effectIcon: "pencil-sketch", label: "Pencil-Sketch" },
        { id: "remove-pic-in-pic", effectIcon: "pic-in-pic", label: "Pic-in-Pic" },

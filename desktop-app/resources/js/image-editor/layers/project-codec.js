...
(function(global) {
  ...
  class ImageEditorProjectCodec {
    ...
    async decode(bytes) {
      ...
      namespace.ImageEditorInnerGlowEffect?.normalizeDocument(document);
      namespace.ImageEditorOuterGlowEffect?.normalizeDocument(document);
      namespace.ImageEditorColorOverlayEffect?.normalizeDocument(document);
      namespace.ImageEditorGradientOverlayEffect?.normalizeDocument(document);
      ...
      namespace.ImageEditorPaintEdgeEffect?.normalizeDocument(document);
      namespace.ImageEditorCollageEffect?.normalizeDocument(document);
      ...
      namespace.ImageEditorPosterizeEffect?.normalizeDocument(document);
      namespace.ImageEditorContrastBwEffect?.normalizeDocument(document);
      namespace.ImageEditorMonochromaticEffect?.normalizeDocument(document);
      namespace.ImageEditorPencilSketchEffect?.normalizeDocument(document);
      namespace.ImageEditorPicInPicEffect?.normalizeDocument(document);

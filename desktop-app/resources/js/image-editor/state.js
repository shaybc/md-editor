...
(function(global) {
  ...
  const TOOLS = Object.freeze(["select", "pencil", "brush", "line", "curve", "rectangle", "rounded-rectangle", "callout", "oval-callout", "cloud-callout", "ellipse", "polygon", "triangle", "diamond", "star", "arrow", "bucket", "text"]);

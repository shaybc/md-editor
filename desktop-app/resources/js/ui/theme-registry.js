    ...
    dark: Object.freeze([
      ...
      freezeTheme({
        ...
        colors: withAliases({
          ...
          "preview-bg": "#15182b",
          "text-color": "#eef2ff",
          "preview-text-color": "#eef2ff",
          "lsp-tooltip-text-color": "#eef2ff",
          "lsp-tooltip-bg": "#242846",
          "lsp-tooltip-border-color": "#363b66",
          "lsp-tooltip-link-color": "#22d3ee",
          "lsp-tooltip-muted-text-color": "#a7b0d8",
          "lsp-tooltip-code-bg": "rgba(79, 91, 157, 0.34)",
          "border-color": "#2d3153",
          "menu-separator-color": "#383d68",
          "header-bg": "#20233c",
          "panel-bg": "#20243f",
          "toolbar-bg": "#1b1f35",
          "button-bg": "#29305a",
          "button-hover": "#343d72",
          "button-active": "#4f63d8",
          "hover-bg": "#262c55",
          "input-bg": "#242846",
          "tree-selection-bg": "#2f3a71",
          "dropzone-bg": "rgba(21, 24, 43, 0.86)",
          "scrollbar-thumb": "#5562a6",
          "scrollbar-track": "#1b1f35",
          "accent-color": "#7c8cff",
          "accent-text": "#22d3ee",
          "accent-contrast": "#ffffff",
          "disabled-text-color": "#7882b3",
          "secondary-text": "#b7bfee",
          "link-color": "#22d3ee",
          "success-color": "#65e572",
          "error-color": "#ff6b9a",
          "table-bg": "#1b1f35",
          "code-bg": "#1b1f35",
          "ai-companion-prompt-bg": "#242846",
          "editor-line-number-color": "#7d87bb",
          "editor-active-line-number-color": "#eef2ff",
          "editor-current-line-bg": "rgba(124, 140, 255, 0.12)",
          "editor-indent-guide-color": "rgba(183, 191, 238, 0.18)",
          "editor-active-indent-guide-color": "rgba(34, 211, 238, 0.42)",
          "editor-selection-match-bg": "rgba(101, 229, 114, 0.24)",
          "editor-selection-match-text-color": "#eef2ff",
          "editor-current-selection-bg": "rgba(124, 140, 255, 0.42)",
          "editor-current-selection-text-color": "#ffffff",
          "editor-gutter-bg": "#191c31",
          "color-fg-muted": "#b7bfee",
          "color-fg-subtle": "#7882b3",
          "color-border-muted": "#262c55",
          "color-neutral-muted": "rgba(85, 98, 166, 0.32)",
          "color-attention-subtle": "rgba(250, 204, 21, 0.18)"
        })
      }),
      freezeTheme({
        id: "vscode-dark",

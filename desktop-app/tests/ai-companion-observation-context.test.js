...
test("AgentState v4 records bounded normalized observations without raw payloads", () => {
  ...
  assert.equal(recorded.state.schemaVersion, 4);
...
test("AgentState v4 keeps only the latest 50 observations while retaining aggregate counts", () => {

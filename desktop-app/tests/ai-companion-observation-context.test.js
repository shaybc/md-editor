...
test("AgentState v2 records bounded normalized observations without raw payloads", () => {
  ...
  assert.equal(recorded.state.schemaVersion, 2);
...
test("AgentState v2 keeps only the latest 50 observations while retaining aggregate counts", () => {

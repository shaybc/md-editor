...
test("AgentState v3 records bounded normalized observations without raw payloads", () => {
  ...
  assert.equal(recorded.state.schemaVersion, 3);
...
test("AgentState v3 keeps only the latest 50 observations while retaining aggregate counts", () => {
